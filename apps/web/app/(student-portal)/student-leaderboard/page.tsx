  ...
  const renderRow = (row: SparkCreatorRow, opts?: { highlight?: boolean }) => {
    ...
    return (
      <div
        key={row.id}
        className={cn(
          "border-b border-white/[0.04] px-4 py-3.5",
      ...
      >
        <div className="md:hidden">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="shrink-0 text-right">
              <div className="text-sm font-semibold tabular">{formatNumber(row.points)} PTS</div>
        ...
        <div className="hidden grid-cols-[72px_minmax(0,1fr)_76px_72px_96px] items-center gap-3 md:grid">
          <div className={rankClass}>{String(row.rank).padStart(2, "0")}</div>
          <div className="min-w-0">{identity}</div>
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="text-left text-[11px] uppercase tracking-[0.12em] text-zinc-500 sm:text-right">
          <div>LIVE COHORT</div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex w-full gap-1 overflow-x-auto rounded-full bg-zinc-900 p-1 text-[11px] font-semibold [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <button
            type="button"
      ...
      <div className="overflow-hidden rounded-2xl border border-white/[0.06]">
        <div className="hidden grid-cols-[72px_minmax(0,1fr)_76px_72px_96px] items-center gap-3 border-b border-white/[0.06] px-4 py-3 text-[10px] font-bold uppercase tracking-[0.14em] text-zinc-500 md:grid">
          <div>Rank</div>
          <div>Creator</div>
